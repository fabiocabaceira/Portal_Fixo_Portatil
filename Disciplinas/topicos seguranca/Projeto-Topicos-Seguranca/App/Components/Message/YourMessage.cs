...
namespace App
{
    public partial class YourMessage : Form
    {
        #region Custom UI
        ...
        public YourMessage(string name, string message, string profileIconName)
        {
            InitializeComponent();
        ...
        private void YourMessage_Load(object sender, EventArgs e)
        {
        ...
        private void TxtBox_MessageHolder_ContentsResized(object sender, ContentsResizedEventArgs e)
        {
            ...
            {
                this._realHeight -= TxtBox_MessageHolder.Height;
                this._realHeight += e.NewRectangle.Height;
            }
